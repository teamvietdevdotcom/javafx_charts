 ...
 * @author TVD
 */
public class StackedAreaChartJavaFX extends Application {
    ...
    public void start(Stage stage) throws Exception {
        stage.setTitle("JavaFX Stacked Area Chart - Team Viet Dev (teamvietdev.com)");
    ...
    public StackedAreaChart createChart() {
